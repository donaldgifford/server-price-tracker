...
- [Agent workflow: don't wait for the operator unnecessarily](#agent-workflow-dont-wait-for-the-operator-unnecessarily)
  - [What is NOT blocking (keep coding)](#what-is-not-blocking-keep-coding)
  - [What IS blocking (stop and ask)](#what-is-blocking-stop-and-ask)
  - [Phase-by-phase blocking matrix](#phase-by-phase-blocking-matrix)
  - [Recommended sequencing for an agent](#recommended-sequencing-for-an-agent)
